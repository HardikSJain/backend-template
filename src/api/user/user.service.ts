...
export class UserService {
  ...
  async create(dto: CreateUserReqDto): Promise<UserResDto> {
    const { username, countryCode, phone, bio, image } = dto;

    // check uniqueness of username and composite (countryCode, phone)
    ...
    if (user) {
      // Keep existing error code mapping for username/email exists to avoid breaking clients
      // but prefer a specific code for phone where applicable
