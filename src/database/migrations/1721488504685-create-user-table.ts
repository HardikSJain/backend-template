...
export class CreateUserTable1720105653064 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE "user" (
        ...
        "country_code" character varying(5) NOT NULL DEFAULT '+91',
    ...
    `);
    await queryRunner.query(`
      CREATE UNIQUE INDEX "UQ_user_country_phone" ON "user" ("country_code", "phone")
      WHERE "deleted_at" IS NULL
    `);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      DROP INDEX "UQ_user_country_phone"
    `);
    await queryRunner.query(`
